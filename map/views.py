...
def get_route_data(request, order_id):
    ...
    start_coord = [current_coords.start_longitude, current_coords.start_latitude]  # стартовая точка пути - хранится в бд
    end_coord = [current_coords.end_longitude, current_coords.end_latitude]  # финишная точка пути - хранится в бд
